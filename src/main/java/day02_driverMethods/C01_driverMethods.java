...
public class C01_driverMethods {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // o browser'in WebDriver'ini indirip projemize eklememiz gerekir

        driver.get("https:/amazon.com");

        // eger kodlarimizi belirli bir sure bekletmek icin
        Thread.sleep(5000);// yazilan mili saniye kadar

        driver.close();

        System.out.println("sayfa url'i" +driver.getCurrentUrl());

        System.out.println("Sayfa2nin title2i"+driver.getTitle());
