 ...
 */
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@name='firstname']")).sendKeys("Nese"+ Keys.ENTER);
        Thread.sleep(1000);

        driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys("Ozer"+Keys.ENTER);
        Thread.sleep(1000);

        WebElement genderRadioButton=driver.findElement(By.xpath("//input[@id='sex-1']"));// Gender
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//button[@class='btn-info']")).click();
